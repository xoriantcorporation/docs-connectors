...
* Invoke Rest API: Operation to invoke https://developer.veevavault.com/api/19.1/#documents[Veeva Vault Rest APIs.]

You can configure the Veeva Vault Connector using Basic Authentication configuration with credentials or OAuth2 Authentication to connect to a Veeva Vault instance and perform operations.
