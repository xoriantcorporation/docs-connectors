...
Guide: xref:veevavault::./veevavault-connector-get-started.adocs[VeevaVault Connector]

Release Notes: xref:veevavault::./veevavault-connector-release-notes.adoc[VeevaVault Connector Release Notes]
...
image:media/tech-ref/image13.png[image,width=590,height=35]
|FALSE|
|Public Key Path|
String
