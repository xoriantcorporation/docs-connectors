...
Reference: xref:./veevavault-connector-reference.adoc[VeevaVault Connector Reference]
...
* New feature OAuth2 Authentication option is added in connector configuration.
* New feature Invoke Rest API operation added that enables to invoke Veeva Vault Rest APIs.
...
* Spark Message Validator operation implemented to validate and verify Spark message with public key and signature received from Vault. 
