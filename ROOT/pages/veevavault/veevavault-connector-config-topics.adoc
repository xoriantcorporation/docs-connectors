...
|*Headers*|The Spark headers received from the Vault. Default is *#[attributes.headers]*
...
|*Query Parameters*|Query Parameters in key-value format to send along with request, if there are no query parameters required in request keep it empty. Default is *Empty list*.
