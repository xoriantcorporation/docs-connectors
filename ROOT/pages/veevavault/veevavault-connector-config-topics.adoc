...
*Follow the instructions mentioned in xref:veevavault::./veevavault-connector-reference.adoc#veevavault-connector-connection-config[Connector Configuration]*
