...
. Following is a configuration for *"1 - Basic Connection"*. For "*2 - OAuth2 Connection*" See link:veevavault-connector-reference.adoc#veevavault-connector-connection-config[Connector Configuration].
