= VeevaVault - Design Center Configuration - Mule 4
...
For information on Flow Designer field values, see the xref:veevavault/veevavault-connector-reference.adoc[Veeva Vault Connector Reference].
